                                       ...
                                       psa_outvec          *outptr)
{
    ...
    for (i = 0; i < ivec_num; i++) {
        ...
        p_connection->invec_base[i]     = tfm_hal_remap_address(curr_partition->p_ldinf, ivecs_local[i].base);
    ...
    for (i = 0; i < ovec_num; i++) {
        ...
        p_connection->outvec_base[i]    = tfm_hal_remap_address(curr_partition->p_ldinf, ovecs_local[i].base);
