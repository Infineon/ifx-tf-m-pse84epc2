...
#define IFX_PROTECTION_MPU_PERIPHERAL_REGION_LIMIT    ((uint32_t)(MMIO_S_M33SYS_START + MMIO_M33SYS_SIZE + MMIO_M55APP_SIZE - 1))
...
typedef struct {
    ...
    cy_en_mpc_size_t     mpc_block_size; /**< Size of MPC memory block. MPC configures the attributes
                                          *   of each fixed-sized block for all PCs */
