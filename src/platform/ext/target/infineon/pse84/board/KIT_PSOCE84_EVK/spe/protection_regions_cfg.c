...
const ifx_msc_agc_resp_config_v1_t ifx_msc_agc_resp_config_v1[] = {
    ...
    {.bus_master = APP_SYS_MS0_MSC,  .gate_resp = CY_MS_CTL_GATE_RESP_ERR, .sec_resp = CY_MS_CTL_SEC_RESP_ERR,},
#endif /* APPCPUSS_SYS_MS_0_PRESENT */
#if APPCPUSS_SYS_MS_1_PRESENT
    {.bus_master = APP_SYS_MS1_MSC,  .gate_resp = CY_MS_CTL_GATE_RESP_ERR, .sec_resp = CY_MS_CTL_SEC_RESP_ERR,},
#endif /* APPCPUSS_SYS_MS_1_PRESENT */
#if APPCPUSS_AXIDMAC0_PRESENT
    {.bus_master = APP_AXIDMAC0_MSC, .gate_resp = CY_MS_CTL_GATE_RESP_ERR, .sec_resp = CY_MS_CTL_SEC_RESP_ERR,},
#endif /* APPCPUSS_AXIDMAC0_PRESENT */
#if APPCPUSS_AXIDMAC1_PRESENT
    {.bus_master = APP_AXIDMAC1_MSC, .gate_resp = CY_MS_CTL_GATE_RESP_ERR, .sec_resp = CY_MS_CTL_SEC_RESP_ERR,},
#endif /* APPCPUSS_AXIDMAC1_PRESENT */
#if APPCPUSS_AXI_MS_0_PRESENT
    {.bus_master = APP_AXI_MS0_MSC,  .gate_resp = CY_MS_CTL_GATE_RESP_ERR, .sec_resp = CY_MS_CTL_SEC_RESP_ERR,},
#endif /* APPCPUSS_AXI_MS_0_PRESENT */
#if APPCPUSS_AXI_MS_1_PRESENT
    {.bus_master = APP_AXI_MS1_MSC,  .gate_resp = CY_MS_CTL_GATE_RESP_ERR, .sec_resp = CY_MS_CTL_SEC_RESP_ERR,},
#endif /* APPCPUSS_AXI_MS_1_PRESENT */
#if APPCPUSS_AXI_MS_2_PRESENT
    {.bus_master = APP_AXI_MS2_MSC,  .gate_resp = CY_MS_CTL_GATE_RESP_ERR, .sec_resp = CY_MS_CTL_SEC_RESP_ERR,},
#endif /* APPCPUSS_AXI_MS_2_PRESENT */
#if APPCPUSS_AXI_MS_3_PRESENT
    {.bus_master = APP_AXI_MS3_MSC,  .gate_resp = CY_MS_CTL_GATE_RESP_ERR, .sec_resp = CY_MS_CTL_SEC_RESP_ERR,},
#endif /* APPCPUSS_AXI_MS_3_PRESENT */
#if APPCPUSS_EXP_MS_0_PRESENT
    {.bus_master = APP_EXP_MS0_MSC,  .gate_resp = CY_MS_CTL_GATE_RESP_ERR, .sec_resp = CY_MS_CTL_SEC_RESP_ERR,},
#endif /* APPCPUSS_EXP_MS_0_PRESENT */
#if APPCPUSS_EXP_MS_1_PRESENT
    {.bus_master = APP_EXP_MS1_MSC,  .gate_resp = CY_MS_CTL_GATE_RESP_ERR, .sec_resp = CY_MS_CTL_SEC_RESP_ERR,},
#endif /* APPCPUSS_EXP_MS_1_PRESENT */
#if APPCPUSS_EXP_MS_2_PRESENT
    {.bus_master = APP_EXP_MS2_MSC,  .gate_resp = CY_MS_CTL_GATE_RESP_ERR, .sec_resp = CY_MS_CTL_SEC_RESP_ERR,},
#endif /* APPCPUSS_EXP_MS_2_PRESENT */
#if APPCPUSS_EXP_MS_3_PRESENT
    {.bus_master = APP_EXP_MS3_MSC,  .gate_resp = CY_MS_CTL_GATE_RESP_ERR, .sec_resp = CY_MS_CTL_SEC_RESP_ERR,},
