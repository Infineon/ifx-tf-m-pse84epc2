...
#warning "Protected Storage partition stack size PS_STACK_SIZE is too small, size is increased to 0x1000"
#undef PS_STACK_SIZE
#define PS_STACK_SIZE                      0x1000
#endif
...
#warning "IFX SE IPC Service stack size IFX_SE_IPC_SERVICE_STACK_SIZE is too small, size is increased to 0x1000"
...
#warning "TFM Platform Service stack size PLATFORM_SP_STACK_SIZE is too small, size is increased to 0x1000"
...
#warning "Attestation partition stack size ATTEST_STACK_SIZE is too small, size is increased to 0x1000"
...
#warning "IFX SE IPC Service stack size IFX_SE_IPC_SERVICE_STACK_SIZE is too small, size is increased to 0x0400"
#undef IFX_SE_IPC_SERVICE_STACK_SIZE
#define IFX_SE_IPC_SERVICE_STACK_SIZE          0x400
#endif
#endif
...
#if DOMAIN_S && (IFX_CORE == IFX_CM33) && defined(IFX_STDIO_S_PREFIX)
#define IFX_STDIO_PREFIX    IFX_STDIO_S_PREFIX
#elif DOMAIN_NS && (IFX_CORE == IFX_CM33) && defined(IFX_STDIO_NS_CM33_PREFIX)
#define IFX_STDIO_PREFIX    IFX_STDIO_NS_CM33_PREFIX
#elif DOMAIN_NS && (IFX_CORE == IFX_CM55) && defined(IFX_STDIO_NS_CM55_PREFIX)
#define IFX_STDIO_PREFIX    IFX_STDIO_NS_CM55_PREFIX
#endif
