...
if (TFM_NS_REG_TEST OR TEST_PSA_API)
    ...
    install(FILES       $<$<BOOL:${IFX_FAMILY_SOURCE_DIR}>:${IFX_FAMILY_SOURCE_DIR}/tests/ifx_tests_ns_config.cmake>
                        $<$<BOOL:${IFX_FAMILY_SOURCE_DIR}>:${IFX_FAMILY_SOURCE_DIR}/tests/ifx_platform_tests_config.h>
                        $<$<BOOL:${IFX_FAMILY_SOURCE_DIR}>:${IFX_FAMILY_SOURCE_DIR}/tests/psa_arch_tests_config.cmake>
                        $<$<BOOL:${IFX_FAMILY_SOURCE_DIR}>:${IFX_FAMILY_SOURCE_DIR}/tests/tfm_tests_config.cmake>
                        ${IFX_PLATFORM_SOURCE_DIR}/tests/ifx_tests_ns_config.cmake
...
if (TEST_NS_IFX_ISOLATION_TEST)
    install(FILES       ${IFX_PLATFORM_SOURCE_DIR}/tests/ifx_isolation_test_data.c
                        ${IFX_FAMILY_SOURCE_DIR}/tests/ifx_isolation_test_data.c
            DESTINATION ${INSTALL_PLATFORM_NS_DIR}/tests
            OPTIONAL
    )
endif()
...
if (TEST_NS_IFX_FRAMEWORK OR TEST_NS_IFX_CODE_COVERAGE)
    install(DIRECTORY   ${IFX_COMMON_SOURCE_DIR}/tests/extra_ns
            DESTINATION ${INSTALL_PLATFORM_NS_DIR}/ifx/tests)
    install(DIRECTORY   ${CMAKE_CURRENT_LIST_DIR}/libs/ifx_gcov_lib
            DESTINATION ${INSTALL_PLATFORM_NS_DIR}/ifx/libs)
endif()
