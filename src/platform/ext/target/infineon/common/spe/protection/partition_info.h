...
/**
 * \brief Convert memory configuration provided by Device Configurator memory to TF-M partition asset
 *
 * \param[in] p_region        Pointer to memory region configuration generated by Device Configurator
