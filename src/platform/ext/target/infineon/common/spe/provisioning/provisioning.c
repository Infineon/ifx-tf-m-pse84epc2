...
TFM_COVERITY_DEVIATE_LINE(MISRA_C_2023_Directive_4_6, "This definition overrides weak function tfm_plat_provisioning_is_required, so we keep numerical types")
