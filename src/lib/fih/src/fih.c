...
#ifdef TFM_FIH_PROFILE_ON
__attribute__((noinline)) bool fih_check_eq_mask(int32_t a_msk, int32_t b_msk)
{
    return (a_msk == b_msk);
}

__attribute__((noinline)) bool fih_check_not_eq_mask(int32_t a_msk, int32_t b_msk)
{
    return (a_msk != b_msk);
}
