...
tfm-configure $(TFM_BUILD_DIR)/.tfm-configure: $(TFM_STAGES_DIR)/tools-pyreq | $(call TFM_WRAP_SPACE,$(TFM_TOOLS_CMAKE)) $(TFM_BUILD_DIR)
	...
	"$(TFM_TOOLS_CMAKE)" $(TFM_CONFIGURE_OPTIONS) -G "Unix Makefiles" -S "$(call TFM_PATH_MIXED,$(TFM_SRC_DIR))" -B $(TFM_BUILD_DIR) "-DPython3_ROOT_DIR=$(call TFM_PATH_MIXED,$(TFM_TOOLS_PYENV_DIR))" && \
...
ifneq (,$(findstring CYGWIN,$(TFM_OS)))
TFM_TOOLS_PYENV_DIR=$(TFM_TOOLS_DIR)/tfm-pyenv/Scripts
TFM_TOOLS_ACTIVATE_PYENV=$(TFM_TOOLS_PYENV_DIR)/activate
# Convert Windows line endings to Unix
TFM_PREPARE_PYENV=dos2unix $(TFM_TOOLS_ACTIVATE_PYENV) &&
else
TFM_TOOLS_PYENV_DIR=$(TFM_TOOLS_DIR)/tfm-pyenv/bin
TFM_TOOLS_ACTIVATE_PYENV=$(TFM_TOOLS_PYENV_DIR)/activate
endif
